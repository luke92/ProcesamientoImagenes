...
@del /f /q funcionesASM_TP2_E2.obj
...
@TP2E2_OC2_PESADO_VARGAS imagen1.rgb imagen2.rgb 300 300 0 0 0 100 resultado.rgb
@gm convert -size 300x300 -depth 8 resultado.rgb win:
@echo.
@echo.
